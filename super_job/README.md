# Super Job
In this project we take the data and programmers from Moscow. Use the website SuperJob. Looking for programmers C, C++, C#, Java, Python , etc., and consider them to be average salary. In the final step - create a graph using this data.
